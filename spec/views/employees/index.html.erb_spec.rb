...
RSpec.describe 'employees/index', type: :view do
  let(:employee1) do
    create(:employee, last_name: 'Иванов', first_name: 'Иван', middle_name: 'Иванович', phone_numbers: '+79001112233')
  end
  let(:employee2) do
    create(:employee, last_name: 'Петров', first_name: 'Сергей', phone_numbers: '+79993334455')
  end
  ...
  it 'renders a list of employees' do
    ...
    assert_select 'table' do
      ...
      assert_select 'tbody' do
        ...
        assert_select 'tr td', text: employee1.created_at.to_s, count: 4
      end
    end
